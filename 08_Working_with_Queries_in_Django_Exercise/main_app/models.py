...
class ArtworkGallery(models.Model):
    ARTIST_NAME_MAX_LEN = 100
    ART_NAME_MAX_LEN = 100
    PRICE_MAX_DIGITS = 10
...
class Laptop(models.Model):
    BRAND_MAX_LEN = 25
    PROCESSOR_MAX_LEN = 25
    MEMORY_HELP_TEXT = 'Memory in GB'
    STORAGE_HELP_TEXT = 'Storage in GB'
    OPERATION_SYSTEM_MAX_LEN = 100
    PRICE_MAX_DIGITS = 10
    PRICE_DECIMAL_PLACES = 2
    ...
    processor = models.CharField(
        max_length=PROCESSOR_MAX_LEN
    )
    memory = models.PositiveIntegerField(
        help_text=MEMORY_HELP_TEXT
    )
    storage = models.PositiveIntegerField(
        help_text=STORAGE_HELP_TEXT
    )
    operation_system = models.CharField(
        max_length=OPERATION_SYSTEM_MAX_LEN,
        choices=LaptopOperationSystemChoices.choices
    )
    price = models.DecimalField(
        max_digits=PRICE_MAX_DIGITS,
        decimal_places=PRICE_DECIMAL_PLACES
